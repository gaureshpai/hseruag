...
const ButtonContainer = () => {
    return (
        <div className='md:max-w-7xl mx-auto flex flex-wrap justify-center gap-2'>
            <Link
                href="/about"
                className="group relative flex items-center justify-center gap-2 text-base font-semibold sm:text-lg md:text-xl min-w-[15rem]"
            >
