...
export const PROJECTS: Project[] = [
  {
    ...
    link: `${GITHUB_URL}/create-next-quick`,
    liveUrl: "https://www.npmjs.com/package/create-next-quick",
    tags: ["frontend", "js", "nextjs", "npm-package", "scaffolding", "starter"],
  ...
  },
  {
    ...
    link: `${GITHUB_URL}/CPRM-Prototype`,
  ...
  },
  {
    title: "Utility Hub",
    description:
      "Utility Hub is a web-based utility platform offering multiple everyday tools in one place. Built with the MERN stack (MongoDB, Express.js, React.js, Node.js) and styled using TailwindCSS, the app provides efficient solutions from file converters to text utilities, all accessible from a centralized dashboard.",
    link: `${GITHUB_URL}/UtilityHub`,
  ...
  },
  {
    title: "HallGrid",
    description:
      "Welcome to the Enigma's Seminar Hall Booking System! This project aims to provide an efficient and streamlined way for Students and lecturers of  AJIET to book seminar halls for various events. Built using Next.js, MongoDB, and Firebase, this system allows easy management of booking requests, hall availability, and event scheduling",
    link: `${GITHUB_URL}/HallGrid`,
    ...
    owner: "Enigma",
    collaborators: ["Shreyya18", "shirha20", "Shikhar-Shetty"],
  ...
  },
  {
    ...
    link: `${GITHUB_URL}/reactnativeepictrailsds`,
  ...
  },
  {
    title: "Hearease",
    description:
      "Therapy web application for Tinnitus – designed to provide specialized support and management tools for individuals experiencing Tinnitus symptoms.",
    link: `${GITHUB_URL}/Hearease`,
    ...
    owner: "gaureshpai",
    collaborators: ["Dhanya Shetty", "Harshitha P"],
  ...
  },
  {
    ...
    link: `${GITHUB_URL}/ggquizopia`,
    liveUrl: "https://ggquizopia.vercel.app/",
    tags: ["html-css-javascript", "javascript", "nextjs"],
  ...
  },
  {
    ...
    link: `${GITHUB_URL}/Interpretations-Management-App`,
  ...
  },
  {
    title: "two-cars",
    description:
      "A fast-paced by Jnanesh , reflex-testing game where players control two cars simultaneously, avoiding obstacles and collecting points. Built using HTML, CSS, and JavaScript, this game is lightweight, responsive, and perfect for casual gameplay.",
    link: `${GITHUB_URL}/two-cars`,
    liveUrl: "https://Jnanesh-two-cars.netlify.app/",
    tags: ["css", "html", "js", "open-source"],
    owner: "Jnanesh",
  ...
  },
  {
    ...
    link: `${GITHUB_URL}/react-epic-trails-ds`,
    ...
    collaborators: ["Himanshu Hegde", "Jnanesh", "Milan C I"],
    screenshot: "/projects/epic.png",
  },
  {
    title: "MLA-list-finder",
    description:
      "MLA List Finder is a web application that allows users to search and view information about Members of the Legislative Assembly (MLAs) based on location.",
    link: `${GITHUB_URL}/MLA-list-finder`,
  ...
  },
  {
    ...
    owner: "Flourish",
    collaborators: ["Milan C I"],
    screenshot: "/projects/demo.png",
  },
  {
    title: "gmaps-demo",
    description:
      "Google maps demo created for the broker website pitch under Kreekarvat technologies",
    link: `${GITHUB_URL}/gmaps-demo`,
    liveUrl: "https://gmaps-demo.vercel.app",
    tags: ["demo", "gmaps", "gmaps-api", "mongodb", "nextjs", "prisma-orm"],
    owner: "Kreekarvat Technologies",
    collaborators: ["Himanshu Hegde"],
    screenshot: "/projects/gmaps.png",
  },
  {
    title: "DocuWave",
    description:
      "The DocuWave website is the web application where the user can view, text-to-speech convert, extract info from, ask question to from the pdf ",
    link: `${GITHUB_URL}/DocuWave`,
    liveUrl: "",
    tags: ["nextjs", "pdf", "pdf-viewer", "typescript"],
  ...
  },
  {
    ...
    link: `${GITHUB_URL}/old_portfolio`,
    liveUrl: "",
    tags: ["html-css-javascript", "mongodb", "nextjs", "typescript"],
  ...
  },
  {
    ...
    link: `${GITHUB_URL}/filetohtmlfileconvertor`,
    liveUrl: "",
    tags: ["html", "java"],
  ...
  },
  {
    ...
    link: `${GITHUB_URL}/Java-Swing-Login-Quiz-App`,
    liveUrl: "",
    tags: ["java"],
    owner: "Lisha Dsouza",
    collaborators: ["Lisha Dsouza"],
  ...
  },
  {
    ...
    link: `${GITHUB_URL}/Java-Swing-Registration-Quiz-App`,
    liveUrl: "",
    tags: ["java", "java-swing", "java-swing-application", "quiz-game"],
    owner: "Lisha Dsouza",
    collaborators: ["Lisha Dsouza"],
