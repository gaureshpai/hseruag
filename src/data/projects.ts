...
export const PROJECT_SHOWCASE: Project[] = [
  {
    ...
    tags: ["nextjs", "prisma-orm", "tailwind CSS", "typescript", "azure", "ffmpeg", "video streaming", "accessibility"],
  ...
  },
  {
    ...
    role: "Full Stack Developer",
    tags: ["Nextjs", "Prisma ORM", "PostgreSQL", "Tailwind CSS", "Git", "TypeScript"],
    collaborators: [],
  ...
  },
  {
    ...
    role: "Full Stack Developer",
    tags: ["MERN", "Tailwind CSS", "JavaScript", "MongoDB", "Vite", "Node.js", "Express.js", "React.js", "Supabase"],
    collaborators: [],
  ...
  },
  {
    ...
    tags: ["Event", "College", "Festival", "Tech Fest", "Nextjs", "Tailwind CSS", "JavaScript", "Frontend"],
    owner: "Aakar 2025",
